...
mod test {
    ...
    fn test_symbol_table_insert_and_lookup() {
        ...
        parent
            .insert(
                "b".into(),
                Some(Type::Nat(Rc::new(TypeNat::new(&Rc::new(Nat {
                    id: 2,
        ...
        parent
            .insert_by_id(
                3,
                Some(Type::Boolean(Rc::new(TypeBool::new(&Rc::new(Bool {
                    id: 3,
                    location: Location::default(),
                    value: false,
                }))))),
    ...
    fn test_lookup_parent_and_children() {
        ...
        root.insert(
            "r".into(),
            Some(Type::String(Rc::new(TypeString::new(&Rc::new(Str {
                id: 4,
                location: Location::default(),
                value: "hi".into(),
            }))))),
    ...
    fn test_build_symbol_table_from_ast() {
        ...
        let symtab =
            crate::codebase::Codebase::<OpenState>::build_symbol_table_for_file_level_types(&prog);
